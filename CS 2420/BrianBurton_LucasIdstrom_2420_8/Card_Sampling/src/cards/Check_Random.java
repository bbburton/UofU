 ...
 * Class Description:
 *
 * This class checks to see how well a random number generator
 * works.  It tests several important properties, including:
 *
 ...
 * Javas_Random_Generator generator and My_Random_Generator
 * generator.
 *
 */
...
public class Check_Random {
  ...
  /**
   * This function runs a series of tests to see how
   * well a random number generator works.
  ...
  public void check_random(Random_Generator generator, int seed) {
    ...
    System.out.println("Number of Zeros after " + this.max_size + " tries: " + this.number_of_zeros_after_ten_thousand);
    ...
    System.out.println("Median number of times a number was generated: " + this.histogram_[this.histogram_.length / 2]);
    System.out.println("Min    number of times a number was generated: " + this.histogram_[0]);
    System.out.println("Max    number of times a number was generated: " + this.histogram_[this.histogram_.length - 1]
        + "\n");
  ...
  public static void main(String[] args) {
    ...
    Random_Generator j_rand = new My_Worst_Random_Generator();
    ...
    j_rand = new Javas_Random_Generator();
    check_rand = new Check_Random();
    check_rand.check_random(j_rand, 0);

    
     System.out.println("---------------------------------------");
     System.out.println ("Testing Better Random Number Generator");
     j_rand = new My_Best_Random_Generator();
     check_rand = new Check_Random();
     check_rand.check_random(j_rand, 0);
  }

  /**
   * This function tests to see if setting the seed to the
   *  same value returns the same sequence
   * @param generator the random number generator to use
   * @return true if setting the seed to the same value returns t
   * he same sequence, false otherwise
   */
  ...
  /**
   * This function determines how many numbers need to be generated
   * before an array of "max_size" is filled.  
   * @param generator the random number generator to test.
   */
   ...
   * @param value the number to determine if it's odd
